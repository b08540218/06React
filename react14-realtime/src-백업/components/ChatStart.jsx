...
const ChatStart = () =>{
  ...
  open() 함수를 이용해서 채팅창을 팝업으로 오픈한다.
    형식] open(팝업창의 요청URL, 창의이름, 창의속성);
      ...
      항상 같은 위치에서 열리게된다. 즉 새로운 창을 열수없으므로 여기서는
      '창의이름'을 부여히지 않아야 한다
   */
  const openChatWin = () =>{
    /**
    useRef를 통해 참조한 input의 DOM을 이용해서 입력값을 얻어온다.
    그리고 팝업창을 띄울때 파라미터로 사용한다. 즉 대화창이 팝업창으로
