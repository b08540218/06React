...
const TopNavi = ()=> {
  ...
  이동을 할 수 있다. 또한 링크를 클릭했을때 acrive 라는 클래스 속성을
  자동으로 추가해준다.
  */
  return (
    <nav>
...
/**
useLocation 훅
 : React Router 를 통해 라우팅된 페이지에서 현제 URL(경로)와 관련된
...
const RouterHooks = () =>{
  ...
  const changeMode = () => {
    ...
    */
    ...
    /**
    es6 에서는 객체 생성시 key와 value가 일치하면 하나의 값만 기술하면 된다.
